 ...
 */
class EmercoinIDPostLoginManager {
   ...
   * @param EmercoinIDPersistentDataHandler $persistent_data_handler
   *   Used for reading data from and writing data to session.
   */
  public function __construct(ConfigFactoryInterface $config_factory, RequestContext $request_context, PathValidatorInterface $path_validator, EmercoinIDPersistentDataHandler $persistent_data_handler) {
   ...
   *
   * @return string
   *   URL where the user should be redirected after EMC login.
   */
